...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<ul class="nav navbar-nav">
			...
			<li><a href="NavController?action=xemGioHang">Giỏ hàng (<%=request.getAttribute("soLuongHang")%>)</a></li>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			? "<li><a href='#'><span class='glyphicon glyphicon-user'></span> Chào, " + request.getAttribute("loggedInUser") + "</a></li>" + "<li><a href='AccountController?action=\"logout\"'><span class='glyphicon glyphicon-log-out'></span> Đăng xuất</a></li>"
